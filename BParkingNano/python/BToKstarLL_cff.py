...
KstarToKPi = cms.EDProducer(
    ...
    preVtxSelection=cms.string(
        'abs(userCand("trk1").vz - userCand("trk2").vz)<1.0'
...
KstarToKPiTable = cms.EDProducer('SimpleCompositeCandidateFlatTableProducer',
...
CountBToKstarEE = cms.EDFilter("PATCandViewCountFilter",
                               ...
                               src=cms.InputTag("BToKstarEE"))
CountBToKstarMuMu = CountBToKstarEE.clone(minNumber=cms.uint32(1),
                                          src=cms.InputTag("BToKstarMuMu"))
...
BToKstarMuMuSequence = cms.Sequence((muonPairsForKstarMuMu * BToKstarMuMu))

BToKstarEESequence = cms.Sequence((electronPairsForKstarEE * BToKstarEE))

BToKstarLLSequence = cms.Sequence(((muonPairsForKstarMuMu * BToKstarMuMu) +
