...
BToPhiMuMu = cms.EDProducer(
    'BToPhiLLBuilder',
    dileptons = cms.InputTag('muonPairsForPhiMuMu', "SelectedDiLeptons"),
...
BToPhiMuMuTable = cms.EDProducer(
    'SimpleCompositeCandidateFlatTableProducer',
...
CountBToPhiMuMu = cms.EDFilter("PATCandViewCountFilter",
    minNumber = cms.uint32(1),
    maxNumber = cms.uint32(999999),
    src = cms.InputTag("BToPhiMuMu")
) 
...
BToPhiLLTables = cms.Sequence(  BToPhiMuMuTable )
